...
**Status:** DONE (2026-07-10) — executed phases 0–5; status log `docs/status/folder-nav.md`, decision record `docs/decisions/0005-folder-nav-local-component-plugins.md`.
