/**
 * Explorer styles: stock @quartz-community/explorer `explorer.scss` (already
 * plain CSS at our pin) with the folder-LINK rules dropped — folders are
 * collapse-only (plan/folder-nav-over-id-urls.md §2). Class names are kept
 * 1:1 with stock so the inline script + any theme expectations keep working.
